...
function injectUI() {
  document.body.insertAdjacentHTML("beforeend", `
    <button type="button" id="mfAiLauncher" class="mf-ai-launcher" aria-label="Open ModelForge AI" aria-expanded="false">✦ AI</button>
    <aside id="mfAiPanel" class="mf-ai-panel" hidden aria-label="ModelForge local AI assistant">
      <div class="mf-ai-head">
        ...
        <button type="button" id="mfAiClose" class="mf-ai-icon" aria-label="Close AI">×</button>
      </div>
      <div class="mf-ai-local-note">Runs on this PC through Ollama. No API key required.</div>
      <div class="mf-ai-chips">
        <button type="button" data-ai-prompt="Explain my current scene and suggest the next modeling step.">Scene review</button>
        <button type="button" data-ai-prompt="Suggest a clean transform setup for the selected object.">Transform help</button>
        <button type="button" data-ai-prompt="Help me design the next ModelForge feature.">Build feature</button>
      </div>
      ...
      <div class="mf-ai-compose">
        ...
        <button type="button" id="mfAiSend" class="mf-ai-send">Send</button>
      </div>
    </aside>
  `);
}
