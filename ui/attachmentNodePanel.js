...
function render() {
    ...
    host.innerHTML = `
        <div class="rocket-node-foundation-head">
            <div><span class="eyebrow">Connectivity</span><strong>Attachment Nodes</strong><small>Step 1 · Node list and basic data only</small></div>
    ...
    empty.innerHTML = nodes.length
        ? `<span>Step 1 only. Viewport gizmo, numeric editing, auto placement and reference guides will be added separately.</span>`
...
function installStyles() {
    ...
    style.textContent = `
        ...
        .node-dot{width:8px;height:8px;border-radius:50%;background:#67d4ff;flex:0 0 auto}.node-copy{min-width:0;display:grid;gap:2px}.node-copy strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#d7dbe2;font-size:10px}.node-copy small{color:#727984;font-size:8px}
