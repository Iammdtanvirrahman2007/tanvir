...
export function openGroupFocusDialog(group) {
    ...
    dialog.innerHTML = `
        <div class="focus-dialog-title">Focus & Transform Pivot</div>
        ...
        <div class="focus-dialog-options">
            <button type="button" data-focus="average">
                ...
                <span><strong>Group Center</strong><small>Focus the average center and use it as the Move / Rotate / Scale pivot</small></span>
            </button>
...
function installStyles() {
    ...
    style.textContent = `
        ...
        .focus-dialog{width:min(430px,calc(100vw - 32px));padding:16px;border:1px solid #3a3d46;border-radius:9px;background:#191a1f;box-shadow:0 24px 70px rgba(0,0,0,.58);color:#e7e8eb}
        ...
        .focus-dialog-options small{display:block;margin-top:3px;color:#777b85;font-size:9px;line-height:1.4}
        ...
        @media(max-width:760px){.focus-dialog-overlay{align-items:end;padding:8px}.focus-dialog{width:100%;border-radius:12px;padding:14px}.focus-dialog-options button{min-height:64px}}
    `;
